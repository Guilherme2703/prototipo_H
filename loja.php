                ...
                <div class="row">
                    <div class="col-md-8" >
                        <div class="row row-cols-1 row-cols-md-2">
                            <?php for ($i = 0; $i < 4; $i++){
                                require('includes/components/produto-item02.php');
                              } 
                              ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="d-flex flex-column mt-4 gap-2">
                            ...
                            <a class="text-dark ms-3" href="#">Acessories</a>
                            <a class="text-dark ms-3" href="#">Hoodies</a>
                            <a class="text-dark ms-3" href="#">Tshirt</a>
